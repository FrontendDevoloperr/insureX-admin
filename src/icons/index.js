...
export const PlusUser = ({ color, ...props }) => (
  <svg
...
export const GoogDriveIcon = ({ color, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    {...props}
    viewBox="0 0 87.3 78"
...
export const NoMessage = ({ color, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" {...props} width="24" height="24">
